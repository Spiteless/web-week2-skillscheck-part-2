...
//Code here
function nananan(val){
    val = val / 2
    if (!Number(val)) {val = "FLYING NOCTURNAL MAMMAL MAN!"}
    return val
}
...
//Code here
let arrayChecker = (val) => Array.isArray(val)
...
let numFromString = (str) => parseInt(str)
...
//Code here
let makeItAString = (val) => val.toString()
